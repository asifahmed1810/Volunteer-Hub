        ...
        <div className="w-11/12 mx-auto mt-20 my-10 p-6 bg-gray-100 rounded-lg shadow-lg">
            ...
            <ul className="list-none space-y-4">
                <li className="flex items-start gap-2">
                    <FaUserShield className="text-indigo-600 mt-1" />
                    <span>
            ...
            <h2 className="text-2xl font-semibold text-indigo-500 mb-4 mt-8">NPM Packages Used</h2>
            ...
            <h2 className="text-2xl font-semibold text-indigo-500 mb-4 mt-8">Live Site</h2>
            <p className="text-lg text-gray-700">
                Experience VolunteerHub in action by visiting our live site:
                <a
                    href="https://volunteerhub-fdad1.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-indigo-600 font-semibold underline ml-1">
                    https://volunteerhub-fdad1.web.app
                </a>
            </p>
        </div>
    );
